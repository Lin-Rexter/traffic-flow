...
const Navbar_Component = () => {
    ...
    */
    ...
    return (
        <nav className={`relative w-full bg-white dark:bg-gray-900`}>
            <div className={`max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-2 py-1`}>
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-6 rtl:space-x-reverse">
                    ...
                    */}
                    ...
                    <button type="button" className="text-white py-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        登入/註冊
                    </button>
                    {/*
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        */}
                        <li className='content-center p-0 pl-14 m-0 w-auto h-auto'>
