    ...
    return (
        <Toast duration={durations} className="fixed top-20 left-1/2 transform -translate-x-1/2 mt-4 w-full md:w-full">
            <div className="flex flex-row items-center justify-center space-x-3 z-[9998] w-full">
                ...
                <div className="flex flex-col justify-center item-center text-sm font-normal w-full">
                    <div className="flex justify-center mb-1 text-lg font-semibold">
                        <p>{title}</p>
                    </div>
                    <div className="flex justify-center mb-1 text-base font-normal whitespace-pre-wrap">
                        <p>{contents}</p>
                    </div>
                </div>
                {showExit &&
